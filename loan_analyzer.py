...
#the total loan in the list is 2750
...
def present_value (future_value, remaining_months, annnual_discout_rate):
    Present_value = future_value  / (1 + annnual_discout_rate/12) ** remaining_months
...
# name the future value and reamining _months from the dictionary 
future_value = new_loan["future_value"]
remaining_months = new_loan["remaining_months"]
Present_Value = present_value(future_value, remaining_months, 0.2)
print(f"The Present value of the loan is: {round(Present_value,2)}")

# The present value of the loan is 861.77 rounded to 2 decimals 
...
# YOUR CODE HERE!
inexpensive_loans = []
# Creating an empty inexpensive_loans list

# @TODO: Loop through all the loans and append any that cost $500 or less to the `inexpensive_loans` list
# YOUR CODE HERE! 
#The loan under the laons is the dictioanry 
...
# YOUR CODE HERE! #"W" means we are writing on the inxepsnsive _loan file
